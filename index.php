...
<html>
	<head>
        ...
        <title>Bio Green of Lee &amp; Collier | Home | Natural Fertilizing Services, Weed Control, Pest Control with Expertise for Your Best Lawns serving Lee County and Collier County in SWFL</title>
	...
	<body>
		...
		<div data-role="footer" data-theme="<?php echo $theme ?>">
			<h1>Powered by <a href="http://mobilegrows.com/">MobileGrows</a> | <a href="http://www.leecollier.biogreen.com/" rel="external">Desktop Site</a></h1>
		</div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		<div data-role="page" id="page1" data-theme="<?php echo $theme ?>">
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
              ...
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-carat-r ui-btn-icon-right " href="#page2" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">Services</a>
                  </div>
              </div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-carat-r ui-btn-icon-right " href="#page2" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">Products</a>
					</div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-carat-r ui-btn-icon-right " href="#page2" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">Gallery</a>
					</div>
				</div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-carat-r ui-btn-icon-right " href="#page2" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">Faq's</a>
                  </div>
              </div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-carat-r ui-btn-icon-right " href="#page2" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">Offers</a>
                  </div>
              </div>
			...
			<div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu">
						<ul id="menu">
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">Services</a></li>
							...
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">Gallery</a></li>
                            <li><a href="#page1" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">Faq's</a></li>
                            <li><a href="#page1" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">Offers</a></li>
